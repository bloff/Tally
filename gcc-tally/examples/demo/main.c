/*
 * Example host program that loads the graph module and runs an instrumented
 * random-walk workload through the Tally minithread runtime.
 */
...
int main(int agrc, char* argv[]){
    ...
    fOpt.file_name = "examples/instrumented/random_walk";
